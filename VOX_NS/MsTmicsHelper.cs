...
namespace VOX_NS
{
    ...
    public class MsTmicsHelper
    {
        ...
        static MsTmicsHelper()
        {
            ...
            _rdbstablepre = "Tmics";
            //设置关系数据库连接字符串
            _connectionstring = "Server=192.168.33.93;Initial Catalog=MES;User ID=tmicsuser;Password=64216554;";
        }
        ...
        public static string RunSql(string sql)
        {
            if (!string.IsNullOrWhiteSpace(sql))
            {
                ...
                {
                    string[] sqlList = CommonHelper.SplitString(sql, "-sqlseparator-");
